 ...
 * 庫存減少
 */
class ReserveDecrease implements Command
{
    use UserStatus;
    private string $method= "desStatus";
            ...
            case "WAIT:NAME":
                ...
                if(!$Items->isEmpty())
                {
                    ...
                    foreach($Items as $Item) {
                        $text .= "庫存物品ID : ".$Item->id." , ".$Item->item_name." ".$Item->item_quantity."個\n";
                    }
                    $text .= "請輸入要減少數量的庫存物品ID,僅限數字";
